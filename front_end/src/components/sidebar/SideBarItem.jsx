...
const SideBarItem = (props) => {
  ...
  return (
    <Link
      to={link ? link : "/"}
      className={`${props.isShow} p-3 space-x-2 flex items-center bg-white rounded-md justify-start shadow-md cursor-pointer transform hover:scale-110 duration-200`}
    >
      <div
