...
const Announcement = () => {
  return (
    <div class="rounded-lg bg-gradient-to-br from-red-50 to-indigo-50 text-gray-800 p-4 m-4 flex flex-col shadow hover:shadow-md transform hover:scale-105 transition duration-200">
      ...
      <div class="pt-4 flex justify-between items-center z-10">
        ...
        <a
          href="/"
          class="px-4 py-2 text-center text-sm text-white shadow-sm rounded-full bg-gradient-to-br from-red-600  to-indigo-600"
        >
